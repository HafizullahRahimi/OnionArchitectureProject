...
using OnionArchitectureProject.Application.Common.Extensions;
...
public class CategoryService(ICategoryRepository categoryRepository, IMapper mapper, IUserRepository userRepository) : ICategoryService
{
